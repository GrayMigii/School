...
public class GUIwuerfel extends JFrame {
  ...
  public void zeigeAugenZahl(int augenZahl){
    
  }
  
  public void zeigeWuerfelSumme(int wuerfelSumme){
    
  }
  
  public void zeigeErfolg(){
    jTextField1.setText("Sie haben gewonnen");
  }
  
  public void zeigeNiederlage(){
    jTextField1.setText("Sie haben verloren");
  }
  
  public void bWuerfeln_ActionPerformed(ActionEvent evt) {
    // TODO add your code here
    if (st1.getWuerfelSumme() < 21) {
      st1.wurfeln();
      st1.addWuerfelAugen();
    } // end of if
    
    if (st1.getWuerfelSumme() > 20 ) {
      if (st1.getWuerfelSumme() == 21) {
        zeigeErfolg();
      }else {
        zeigeNiederlage(); 
